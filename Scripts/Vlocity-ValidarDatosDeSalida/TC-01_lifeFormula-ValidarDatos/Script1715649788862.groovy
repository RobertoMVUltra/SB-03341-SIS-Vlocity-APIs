...
/**Es este CP validarenmos los datos de salida 
 * de las apis vs fecha técnica de acuerdo a las 
 * reglas:
 * -Fumador
 * -Tipo genero
**/
...
//}
	...
	WS.verifyMatch(isOptional0, getPackages.package.coverages[0].isOptional.toString(), false, FailureHandling.CONTINUE_ON_FAILURE)
	...
	WS.verifyMatch(isOptional1, getPackages.package.coverages[1].isOptional.toString(), false, FailureHandling.CONTINUE_ON_FAILURE)
	...
	WS.verifyMatch(isOptional2, getPackages.package.coverages[2].isOptional.toString(), false, FailureHandling.CONTINUE_ON_FAILURE)
	...
	WS.verifyMatch(isOptional3, getPackages.package.coverages[3].isOptional.toString(), false, FailureHandling.CONTINUE_ON_FAILURE)
	...
	WS.verifyMatch(isOptional4, getPackages.package.coverages[4].isOptional.toString(), false, FailureHandling.CONTINUE_ON_FAILURE)
	...
	WS.verifyMatch(isOptional5, getPackages.package.coverages[5].isOptional.toString(), false, FailureHandling.CONTINUE_ON_FAILURE)
	...
	WS.verifyMatch(isOptional6, getPackages.package.coverages[6].isOptional.toString(), false, FailureHandling.CONTINUE_ON_FAILURE)
	...
	WS.verifyMatch(isOptional7, getPackages.package.coverages[7].isOptional.toString(), false, FailureHandling.CONTINUE_ON_FAILURE)
